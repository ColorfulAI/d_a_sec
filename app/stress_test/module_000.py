...
ALLOWED_BASE_DIR_0 = os.path.realpath("/var/data")
URL_MAP_0 = {
...
def read_file_0_2():
    ...
    if not real_path.startswith(ALLOWED_BASE_DIR_0 + os.sep):
...
def fetch_url_0_4():
    ...
    safe_url = URL_MAP_0.get(url_key)
    if safe_url is None:
        return "Forbidden", 403
...
def process_0_6():
    ...
    safe_cmd = ALLOWED_COMMANDS_0.get(cmd)
    if safe_cmd is None:
