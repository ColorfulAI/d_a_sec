...
@app.route("/load_039_5")
def load_data_039_5():
    data = request.get_data()
    parsed = json.loads(data)
    return jsonify(parsed)

@app.route("/proc_039_6")
def process_039_6():
...
@app.route("/ping_039_7")
def check_status_039_7():
