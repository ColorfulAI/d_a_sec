...
ALLOWED_BASE_DIR_7 = os.path.realpath("/var/data")
URL_MAP_7 = {
...
def read_file_7_2():
    ...
    if not real_path.startswith(ALLOWED_BASE_DIR_7 + os.sep):
...
def fetch_url_7_4():
    ...
    safe_url = URL_MAP_7.get(url_key)
    if safe_url is None:
        return "Forbidden", 403
...
def process_7_6():
    ...
    safe_cmd = ALLOWED_COMMANDS_7.get(cmd)
    if safe_cmd is None:
