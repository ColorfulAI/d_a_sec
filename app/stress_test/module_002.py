...
ALLOWED_BASE_DIR_2 = os.path.realpath("/var/data")
URL_MAP_2 = {
...
def read_file_2_2():
    ...
    if not real_path.startswith(ALLOWED_BASE_DIR_2 + os.sep):
...
def fetch_url_2_4():
    ...
    safe_url = URL_MAP_2.get(url_key)
    if safe_url is None:
        return "Forbidden", 403
...
def process_2_6():
    ...
    safe_cmd = ALLOWED_COMMANDS_2.get(cmd)
    if safe_cmd is None:
