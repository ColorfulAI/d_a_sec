...
ALLOWED_BASE_DIR_35 = os.path.realpath(os.path.join(os.path.dirname(__file__), "data"))
ALLOWED_URLS_35 = {
    "example": "https://example.com/",
    "api": "https://api.example.com/",
}
ALLOWED_COMMANDS_35 = {"ls": "ls", "whoami": "whoami", "date": "date", "uptime": "uptime"}
...
def run_cmd_35_1():
    ...
    if not safe_path.startswith(ALLOWED_BASE_DIR_35 + os.sep):
...
def fetch_url_35_4():
    ...
    url = ALLOWED_URLS_35.get(url_key)
    if url is None:
...
def process_35_6():
    ...
    cmd = ALLOWED_COMMANDS_35.get(cmd_name)
    if cmd is None:
