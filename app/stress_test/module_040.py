...
@app.route("/load_040_5")
def load_data_040_5():
    data = request.get_data()
    parsed = json.loads(data)
    return jsonify(parsed)

@app.route("/proc_040_6")
def process_040_6():
...
@app.route("/ping_040_7")
def check_status_040_7():
