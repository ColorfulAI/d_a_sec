...
ALLOWED_BASE_DIR_38 = os.path.realpath(os.path.join(os.path.dirname(__file__), "data"))
ALLOWED_URLS_38 = {
    "example": "https://example.com/",
    "api": "https://api.example.com/",
}
ALLOWED_COMMANDS_38 = {"ls": "ls", "whoami": "whoami", "date": "date", "uptime": "uptime"}
...
def run_cmd_38_1():
    ...
    if not safe_path.startswith(ALLOWED_BASE_DIR_38 + os.sep):
...
def fetch_url_38_4():
    ...
    url = ALLOWED_URLS_38.get(url_key)
    if url is None:
...
def process_38_6():
    ...
    cmd = ALLOWED_COMMANDS_38.get(cmd_name)
    if cmd is None:
