...
@app.route("/load_038_5")
def load_data_038_5():
    data = request.get_data()
    parsed = json.loads(data)
    return jsonify(parsed)

@app.route("/proc_038_6")
def process_038_6():
...
@app.route("/ping_038_7")
def check_status_038_7():
